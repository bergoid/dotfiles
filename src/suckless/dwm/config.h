...
static const char *root_bg_color    = DEFAULT_BG_COLOR;
...
// The 'dwm' user needs to have NOPASSWD 'sudo' access to the 'shutdown' command:
...
//    { MODKEY,                       XK_d,      incnmaster,     {.i = -1 } },
    ...
    { MODKEY,                       XK_equal,  setmfact,       {.f = 1.5} }, // set mfact to 0.5 absolutely
